...
const STR = {
  zh: {
    ...
    check: {
      nav: "CHECK",
      title: (n) => `帮 ${n} 检查一款商品`,
      criteria: "拍商品外观：AI 综合辨识与判断。输入条码或手动：只比对过敏原与年龄段。",
  ...
  en: {
    ...
    check: {
      ...
      criteria: "Photo: AI identifies the product and judges it against the whole profile. Barcode or manual: allergens and life stage only.",
